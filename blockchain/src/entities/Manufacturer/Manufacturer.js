...
import ManufacturerRawMaterial from "./manufactureRawMaterial.js";
...
const routes = [
  ...
  {
    path: "/manufacture-raw-materials",
    name: "Manufacture Raw materials",
    icon: ViewTrans,
    component: ManufacturerRawMaterial,
    layout: "/manufacturer"
  },
  {
    path: "/user",
        ...
        if (prop.layout === "/manufacturer") {
          return (
            <Route
              ...
              render={() => (
                <prop.component accounts={rest.accounts} supplyChain={rest.supplyChain} web3={rest.web3} />
              )}
              key={key}
            />
          );
