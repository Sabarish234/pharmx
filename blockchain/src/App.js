...
async loadWeb3() {
  ...
  async loadBlockChain() {
    ...
    console.log('Network Data from JSON: ', networkData);
      ...
      return (
        <Router>
          <Switch>
            ...
            <Route path="/owner" render={(props) => (<Owner accounts={this.state.accounts} supplyChain={this.state.supplyChain} web3={this.state.web3} />)} />
            ...
            <Route path="/supplier" render={(props) => (<Supplier accounts={this.state.accounts} supplyChain={this.state.supplyChain} web3={this.state.web3} />)} />
            ...
            <Route path="/transporter" render={(props) => (<Transporter accounts={this.state.accounts} supplyChain={this.state.supplyChain} web3={this.state.web3} />)} />
            ...
            <Route path="/manufacturer" render={(props) => (<Manufacturer accounts={this.state.accounts} supplyChain={this.state.supplyChain} web3={this.state.web3} />)} />
            ...
            <Route path="/wholesaler" render={(props) => (<Wholesaler accounts={this.state.accounts} supplyChain={this.state.supplyChain} web3={this.state.web3} />)} />
            ...
            <Route path="/distributor" render={(props) => (<Distributor accounts={this.state.accounts} supplyChain={this.state.supplyChain} web3={this.state.web3} />)} />
